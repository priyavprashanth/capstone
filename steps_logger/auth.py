...
3. In addition, the function get_token_auth_header is written in-line with the requirements 
from the Coffee Shop assignment, based on the learnings from the chapter Identity and Access Management
